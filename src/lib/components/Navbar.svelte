...
<nav class="fixed top-0 left-0 w-full z-50 px-6 py-5 flex items-center justify-between transition-all duration-300 {isScrolled ? 'bg-white text-black py-4 shadow-sm' : 'bg-transparent text-white'}">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="/" class="text-xl font-bold tracking-wide uppercase font-display">EPS</a>
    </div>

    <!-- Center Links -->
    <div class="hidden md:flex items-center gap-8 text-sm font-medium tracking-wide">
        <a href="#technology" class="hover:opacity-70 transition-opacity">Technology</a>
        <a href="#applications" class="hover:opacity-70 transition-opacity">Applications</a>
        <a href="#certification" class="hover:opacity-70 transition-opacity">Certification</a>
        <a href="#team" class="hover:opacity-70 transition-opacity">Team</a>
    </div>
