<footer class="bg-gray-950 text-white py-16 px-6 md:px-12">
    <div class="max-w-[1400px] mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-2xl font-bold tracking-wide uppercase">Electric Power Systems</span>
                </div>
                <p class="text-gray-400 text-sm leading-relaxed max-w-md mb-6">
                    Powering Upward Mobility. Delivering certified electric aviation through modular, lightweight battery systems.
                </p>
                <div class="text-[10px] font-mono text-gray-500 uppercase tracking-wider">
                    Founded 2008 • Indianapolis, IN
                </div>
            </div>
            ...
            <!-- Solutions -->
            <div>
                <h4 class="text-sm font-semibold uppercase tracking-wider mb-4">Solutions</h4>
                <ul class="space-y-2 text-sm text-gray-400">
                    <li><a href="#technology" class="hover:text-white transition-colors">Technology</a></li>
                    <li><a href="#applications" class="hover:text-white transition-colors">Applications</a></li>
                    <li><a href="#certification" class="hover:text-white transition-colors">Certification</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Defense Solutions</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Commercial Aviation</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="text-xs text-gray-500">
                © {new Date().getFullYear()} Electric Power Systems. All rights reserved.
            </div>
